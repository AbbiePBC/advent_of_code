...
TEST(Dec8, test_find_chars_for_1){
    ...
    two_letter_vector = find_chars_for_1(vec);
    ...
    vec2[2] = "dgebacf";
    vec2[3] = "gc";
    two_letter_vector2 = find_chars_for_1(vec2);
    ASSERT_EQ(two_letter_vector2[0], 'g');
    ASSERT_EQ(two_letter_vector2[1], 'c');
    char top_line = find_top_line(vec2[0], two_letter_vector2);
    ASSERT_EQ(top_line, 'f');
    top_line = find_top_line(vec2[1], two_letter_vector2);
    ASSERT_EQ(top_line, 'b');
